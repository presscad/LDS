...
bool CIntelliCore::AddHeadType_ZB2(STDTEMPL *pStdTempl)
{
	...
	pQuadSect->arrRods[1]=-25;
	//约束条件
	//pStdTempl->condition.CompileExprStr("Abs(Node#3.x-Node#5.x)<100&&Abs(Node#9.x-Node#19.x)<100");
	return true;
}
#endif
