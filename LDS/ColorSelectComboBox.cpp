...
void CColorSelectComboBox::InitBox(COLORREF crColor)
{
	...
	AddColor (RGB(128,0,0),"Dull Red");
	AddColor (RGB(0,128,0),"Dull Green");
	AddColor (RGB(0,0,128),"Dull Blue");
	AddColor (RGB(128,128,0),"Dull Yellow");
	AddColor (RGB(128,0,128),"Dull Purple");
	AddColor (RGB(0,128,128),"Dull Cyan");
	...
	{
#ifdef AFX_TARG_ENU_ENGLISH
		iCur = AddColor(crColor,"User Defined",FALSE);
#else 
