...
static BOOL ModifyDatumPointPropValue(CPropertyList	*pPropList,CPropTreeItem *pItem, CString &valueStr)
{
	...
	else if(CDefinedViewDlg::GetPropID("m_xLineStart.des_para.RODEND.hRod")==pItem->m_idProp)	//角钢句柄
		sscanf(valueStr.GetBuffer(1),"%X",&(pStartPoint->des_para.RODEND.hRod));
	else if(CDefinedViewDlg::GetPropID("m_xLineStart.des_para.RODEND.direction")==pItem->m_idProp)	//0.基准角钢方向:始->终;1.终->始
		pStartPoint->des_para.RODEND.direction=valueStr[0]-'0';
	else if(CDefinedViewDlg::GetPropID("m_xLineStart.des_para.RODEND.offset_wing")==pItem->m_idProp)//0.X肢;1.Y肢
	...
	else if(CDefinedViewDlg::GetPropID("m_xLineStart.des_para.LINEPARTNODE.hLinePart")==pItem->m_idProp)	//角钢句柄
		sscanf(valueStr,"%X",&(pStartPoint->des_para.RODNODE.hRod ));
	else if(CDefinedViewDlg::GetPropID("m_xLineStart.des_para.LINEPARTNODE.hNode")==pItem->m_idProp)	//基准节点句柄
	...
	else if(CDefinedViewDlg::GetPropID("m_xLineStart.des_para.SCALE_NODE.hLinePart")==pItem->m_idProp)//基准杆件句柄
		sscanf(valueStr.GetBuffer(1),"%X",&(pStartPoint->des_para.SCALE_NODE.hLinePart));
	else if(CDefinedViewDlg::GetPropID("m_xLineStart.des_para.SCALE_NODE.hStartNode")==pItem->m_idProp)	//始端节点句柄
		sscanf(valueStr.GetBuffer(1),"%X",&(pStartPoint->des_para.SCALE_NODE.hStartNode));
	else if(CDefinedViewDlg::GetPropID("m_xLineStart.des_para.SCALE_NODE.hEndNode")==pItem->m_idProp)		//终端节点句柄
		sscanf(valueStr.GetBuffer(1),"%X",&(pStartPoint->des_para.SCALE_NODE.hEndNode));
	else if(CDefinedViewDlg::GetPropID("m_xLineStart.des_para.SCALE_NODE.start_offset_dist")==pItem->m_idProp)//始端偏移量
		pStartPoint->des_para.SCALE_NODE.start_offset_dist=atof(valueStr);
	else if(CDefinedViewDlg::GetPropID("m_xLineStart.des_para.SCALE_NODE.end_offset_dist")==pItem->m_idProp)	//终端偏移量
		pStartPoint->des_para.SCALE_NODE.end_offset_dist=atof(valueStr);
	else if(CDefinedViewDlg::GetPropID("m_xLineStart.des_para.SCALE_NODE.offset_scale")==pItem->m_idProp)		//偏移比例
		pStartPoint->des_para.SCALE_NODE.offset_scale=atof(valueStr);
	else if(CDefinedViewDlg::GetPropID("m_xLineStart.des_para.SCALE_NODE.offset_dist")==pItem->m_idProp)		//在等分基础上的偏移值
	...
	{	//辅助线终点
		...
		else if(CDefinedViewDlg::GetPropID("m_xLineEnd.des_para.RODEND.hRod")==pItem->m_idProp)	//角钢句柄
			sscanf(valueStr.GetBuffer(1),"%X",&(pEndPoint->des_para.RODEND.hRod));
		else if(CDefinedViewDlg::GetPropID("m_xLineEnd.des_para.RODEND.direction")==pItem->m_idProp)	//0.基准角钢方向:始->终;1.终->始
			pEndPoint->des_para.RODEND.direction=valueStr[0]-'0';
		else if(CDefinedViewDlg::GetPropID("m_xLineEnd.des_para.RODEND.offset_wing")==pItem->m_idProp)//0.X肢;1.Y肢
		...
		else if(CDefinedViewDlg::GetPropID("m_xLineEnd.des_para.LINEPARTNODE.hLinePart")==pItem->m_idProp)	//角钢句柄
			sscanf(valueStr.GetBuffer(1),"%X",&(pEndPoint->des_para.RODNODE.hRod ));
		else if(CDefinedViewDlg::GetPropID("m_xLineEnd.des_para.LINEPARTNODE.hNode")==pItem->m_idProp)	//基准节点句柄
		...
		else if(CDefinedViewDlg::GetPropID("m_xLineEnd.des_para.SCALE_NODE.hLinePart")==pItem->m_idProp)//基准杆件句柄
			sscanf(valueStr.GetBuffer(1),"%X",&(pEndPoint->des_para.SCALE_NODE.hLinePart));
		else if(CDefinedViewDlg::GetPropID("m_xLineEnd.des_para.SCALE_NODE.hStartNode")==pItem->m_idProp)	//始端节点句柄
			sscanf(valueStr.GetBuffer(1),"%X",&(pEndPoint->des_para.SCALE_NODE.hStartNode));
		else if(CDefinedViewDlg::GetPropID("m_xLineEnd.des_para.SCALE_NODE.hEndNode")==pItem->m_idProp)		//终端节点句柄
			sscanf(valueStr.GetBuffer(1),"%X",&(pEndPoint->des_para.SCALE_NODE.hEndNode));
		else if(CDefinedViewDlg::GetPropID("m_xLineEnd.des_para.SCALE_NODE.start_offset_dist")==pItem->m_idProp)//始端偏移量
			pEndPoint->des_para.SCALE_NODE.start_offset_dist=atof(valueStr);
		else if(CDefinedViewDlg::GetPropID("m_xLineEnd.des_para.SCALE_NODE.end_offset_dist")==pItem->m_idProp)	//终端偏移量
			pEndPoint->des_para.SCALE_NODE.end_offset_dist=atof(valueStr);
		else if(CDefinedViewDlg::GetPropID("m_xLineEnd.des_para.SCALE_NODE.offset_scale")==pItem->m_idProp)		//偏移比例
			pEndPoint->des_para.SCALE_NODE.offset_scale=atof(valueStr);
		else if(CDefinedViewDlg::GetPropID("m_xLineEnd.des_para.SCALE_NODE.offset_dist")==pItem->m_idProp)		//在等分基础上的偏移值
...
static BOOL ModifyDatumVectorPropValue(CPropertyList *pPropList,CPropTreeItem *pItem, CString &valueStr)
{
	...
	if(CDefinedViewDlg::GetPropID("m_xFaceNorm.hVicePart")==pItem->m_idProp)//基准杆件句柄
...
CHashTable<DWORD> CDefinedViewDlg::propStatusHashtable;	//属性状态哈希表
...
//辅助(展开)线始点
	...
	propHashtable.SetValueAt("m_xLineStart.des_para.AXIS_INTERS.wing_offset_style2",id++);//0.g;1.g1;2.g2;3.g3;4.自定义
	...
	propHashtable.SetValueAt("m_xLineStart.des_para.AXIS_INTERS.norm_offset",id++);	//法向偏移量;
	//角钢楞点
	propHashtable.SetValueAt("m_xLineStart.des_para.RODEND.hRod",id++);				//角钢句柄
	propHashtable.SetValueAt("m_xLineStart.des_para.RODEND.direction",id++);			//0.基准角钢方向:始->终;1.终->始
	propHashtable.SetValueAt("m_xLineStart.des_para.RODEND.offset_wing",id++);		//0.X肢;1.Y肢
	propHashtable.SetValueAt("m_xLineStart.des_para.RODEND.wing_offset_style",id++);	//0.g;1.g1;2.g2;3.g3;4.自定义
	propHashtable.SetValueAt("m_xLineStart.des_para.RODEND.wing_offset_dist",id++);
	propHashtable.SetValueAt("m_xLineStart.des_para.RODEND.len_offset_dist",id++);	//肢向偏移值;纵向偏移值;
	propHashtable.SetValueAt("m_xLineStart.des_para.RODEND.bIncOddEffect",id++);		//纵向偏移值计入正负头影响
	propHashtable.SetValueAt("m_xLineStart.des_para.RODEND.norm_offset",id++);		//法向偏移量
	//杆件上节点为基准
	propHashtable.SetValueAt("m_xLineStart.des_para.LINEPARTNODE.hLinePart",id++);	//角钢句柄
	propHashtable.SetValueAt("m_xLineStart.des_para.LINEPARTNODE.hNode",id++);		//基准节点句柄
	propHashtable.SetValueAt("m_xLineStart.des_para.LINEPARTNODE.bFaceOffset",id++);
	propHashtable.SetValueAt("m_xLineStart.des_para.LINEPARTNODE.direction",id++);	//0.基准角钢方向:始->终;1.终->始
	propHashtable.SetValueAt("m_xLineStart.des_para.LINEPARTNODE.offset_wing",id++);	//0.X肢;1.Y肢
	propHashtable.SetValueAt("m_xLineStart.des_para.LINEPARTNODE.wing_offset_style",id++);//0.g;1.g1;2.g2;3.g3;4.自定义
	propHashtable.SetValueAt("m_xLineStart.des_para.LINEPARTNODE.wing_offset_dist",id++);
	propHashtable.SetValueAt("m_xLineStart.des_para.LINEPARTNODE.len_offset_dist",id++);	//肢向偏移值;纵向偏移值;
	propHashtable.SetValueAt("m_xLineStart.des_para.LINEPARTNODE.norm_offset",id++);		//法向偏移量;
	...
	//两节点间比例等分点
	propHashtable.SetValueAt("m_xLineStart.des_para.SCALE_NODE.hLinePart",id++);			//基准杆件句柄
	propHashtable.SetValueAt("m_xLineStart.des_para.SCALE_NODE.hStartNode",id++);		//始端节点句柄
	propHashtable.SetValueAt("m_xLineStart.des_para.SCALE_NODE.hEndNode",id++);			//终端节点句柄
	propHashtable.SetValueAt("m_xLineStart.des_para.SCALE_NODE.start_offset_dist",id++);	//始端偏移量
	propHashtable.SetValueAt("m_xLineStart.des_para.SCALE_NODE.end_offset_dist",id++);	//终端偏移量
	propHashtable.SetValueAt("m_xLineStart.des_para.SCALE_NODE.offset_scale",id++);		//偏移比例
	propHashtable.SetValueAt("m_xLineStart.des_para.SCALE_NODE.offset_dist",id++);		//在等分基础上的偏移值
//辅助线终点
	...
	propHashtable.SetValueAt("m_xLineEnd.des_para.AXIS_INTERS.wing_offset_style2",id++);//0.g;1.g1;2.g2;3.g3;4.自定义
	...
	propHashtable.SetValueAt("m_xLineEnd.des_para.AXIS_INTERS.norm_offset",id++);	//法向偏移量;
	//角钢楞点
	propHashtable.SetValueAt("m_xLineEnd.des_para.RODEND.hRod",id++);				//角钢句柄
	propHashtable.SetValueAt("m_xLineEnd.des_para.RODEND.direction",id++);			//0.基准角钢方向:始->终;1.终->始
	propHashtable.SetValueAt("m_xLineEnd.des_para.RODEND.offset_wing",id++);		//0.X肢;1.Y肢
	propHashtable.SetValueAt("m_xLineEnd.des_para.RODEND.wing_offset_style",id++);	//0.g;1.g1;2.g2;3.g3;4.自定义
	propHashtable.SetValueAt("m_xLineEnd.des_para.RODEND.wing_offset_dist",id++);
	propHashtable.SetValueAt("m_xLineEnd.des_para.RODEND.len_offset_dist",id++);	//肢向偏移值;纵向偏移值;
	propHashtable.SetValueAt("m_xLineEnd.des_para.RODEND.bIncOddEffect",id++);		//纵向偏移值计入正负头影响
	propHashtable.SetValueAt("m_xLineEnd.des_para.RODEND.norm_offset",id++);		//法向偏移量
	//杆件上节点为基准
	propHashtable.SetValueAt("m_xLineEnd.des_para.LINEPARTNODE.hLinePart",id++);	//角钢句柄
	propHashtable.SetValueAt("m_xLineEnd.des_para.LINEPARTNODE.hNode",id++);		//基准节点句柄
	propHashtable.SetValueAt("m_xLineEnd.des_para.LINEPARTNODE.bFaceOffset",id++);
	propHashtable.SetValueAt("m_xLineEnd.des_para.LINEPARTNODE.direction",id++);	//0.基准角钢方向:始->终;1.终->始
	propHashtable.SetValueAt("m_xLineEnd.des_para.LINEPARTNODE.offset_wing",id++);	//0.X肢;1.Y肢
	propHashtable.SetValueAt("m_xLineEnd.des_para.LINEPARTNODE.wing_offset_style",id++);//0.g;1.g1;2.g2;3.g3;4.自定义
	propHashtable.SetValueAt("m_xLineEnd.des_para.LINEPARTNODE.wing_offset_dist",id++);
	propHashtable.SetValueAt("m_xLineEnd.des_para.LINEPARTNODE.len_offset_dist",id++);	//肢向偏移值;纵向偏移值;
	propHashtable.SetValueAt("m_xLineEnd.des_para.LINEPARTNODE.norm_offset",id++);		//法向偏移量;
	...
	//两节点间比例等分点
	propHashtable.SetValueAt("m_xLineEnd.des_para.SCALE_NODE.hLinePart",id++);			//基准杆件句柄
	propHashtable.SetValueAt("m_xLineEnd.des_para.SCALE_NODE.hStartNode",id++);		//始端节点句柄
	propHashtable.SetValueAt("m_xLineEnd.des_para.SCALE_NODE.hEndNode",id++);			//终端节点句柄
	propHashtable.SetValueAt("m_xLineEnd.des_para.SCALE_NODE.start_offset_dist",id++);	//始端偏移量
	propHashtable.SetValueAt("m_xLineEnd.des_para.SCALE_NODE.end_offset_dist",id++);	//终端偏移量
	propHashtable.SetValueAt("m_xLineEnd.des_para.SCALE_NODE.offset_scale",id++);		//偏移比例
	propHashtable.SetValueAt("m_xLineEnd.des_para.SCALE_NODE.offset_dist",id++);		//在等分基础上的偏移值
	propHashtable.SetValueAt("m_xLineEnd.datum_pos_style",id++);
	propHashtable.SetValueAt("m_xLineEnd",id++);
	propHashtable.SetValueAt("m_xLineEnd.x",id++);
	propHashtable.SetValueAt("m_xLineEnd.y",id++);
...
int CDefinedViewDlg::GetPropStatus(long id)					//得到属性状态
{
	DWORD dwStatus;
...
BOOL CDefinedViewDlg::SetPropStatus(long id,BOOL bHide)		//设置属性状态
{
	DWORD dwStatus;
	if(bHide)
