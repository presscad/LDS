...
public:
	// Constructors
	CImageIterator ( void );
	CImageIterator ( CImageFile *image );
	operator CImageFile* ();
...
/////////////////////////////////////////////////////////////////////
inline
CImageIterator::CImageIterator(CImageFile *imageImpl): ima(imageImpl)
{
	if (ima)
...
/////////////////////////////////////////////////////////////////////
inline
CImageIterator::operator CImageFile* ()
{
	return ima;
}
/////////////////////////////////////////////////////////////////////
...
{
	if (++Itx < (int)ima->GetEffWidth())
		return 1;
	else if (++Ity < (int)ima->GetHeight())
	{
		IterImage += ima->GetEffWidth();
		Itx = 0;
		return 1;
