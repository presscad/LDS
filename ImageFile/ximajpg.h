...
public:
	...
	~CxExifInfo();
	bool DecodeExif(FILE *fp, int nReadMode = EXIF_READ_EXIF);
	bool EncodeExif(FILE *fp);
...
public:
	...
	static void TermDestination(j_compress_ptr cinfo)
	{
		...
		if (ferror(pDest->m_pFile)) ERREXIT(cinfo, JERR_FILE_WRITE);
		return;
	}
