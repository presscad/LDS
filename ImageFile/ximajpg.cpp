...
////////////////////////////////////////////////////////////////////////////////
CImageFileJpeg::CImageFileJpeg()//: CxImage(CXIMAGE_FORMAT_JPG)
{
	m_exif = NULL;
...
////////////////////////////////////////////////////////////////////////////////
bool CImageFileJpeg::DecodeExif(FILE *fp)
{
	m_exif = new CxExifInfo(&m_exifinfo);
	if (m_exif){
		long pos=ftell(fp);
		m_exif->DecodeExif(fp);
...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
bool CImageFileJpeg::ReadImageFile(FILE *fp)
{
	bool is_exif = false;
	is_exif = DecodeExif(fp);
...
////////////////////////////////////////////////////////////////////////////////
bool CImageFileJpeg::WriteImageFile(FILE *fp)
{
#ifdef TEMP_SET_MACRO	//wjh 2009-11-26
...
//#endif
	...
	*/
	...
	if (m_exif && m_exif->m_exifinfo->IsExif){
		...
		fseek(fp,pos,SEEK_SET);
		m_exif->DecodeExif(fp,EXIF_READ_IMAGE);
		// save back the image, adding EXIF section
		fseek(fp,pos,SEEK_SET);
		m_exif->EncodeExif(fp);
	}
#endif
	/* And we're done! */
	return true;
