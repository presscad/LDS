...
void AddPartTblSheet(CModelBOM &bom,LPDISPATCH pWorkSheet)
{
	...
	str_arr[0] = "件号"; str_arr[1] = "规格";str_arr[2] = "长度"; str_arr[3] = "材质"; 
	str_arr[4] = "单基数";str_arr[5] = "加工数"; str_arr[6] = "单重"; str_arr[7] = "总重"; 
	str_arr[8] = "工艺";
	double col_arr[9] = { 10.5,11.5,11.5,9.5,
						  10.0,10.0,12.0,12.5,
						  38.0};
	...
	for(SUPERLIST_NODE<BOMPART>*pNode=BomArr.GetFirst();pNode;pNode=BomArr.GetNext())
	{
		...
		map.SetValueAt(index, 3, COleVariant(sMaterial));
	...
	CExcelOper::SetRangeHorizontalAlignment(excel_sheet, "D2", CXhChar16("D%d",index), COleVariant((long)2));
	for (int i = 0; i < Q345RowIndexArr.GetSize(); i++)
	{
		int rowIndex = Q345RowIndexArr[i];
		CXhChar16 curCell("D%d", rowIndex);
