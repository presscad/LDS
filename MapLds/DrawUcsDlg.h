#if !defined(AFX_DRAWUCSDLG_H__29FE68C5_B903_4C19_B7EE_FFD7EBABFDF3__INCLUDED_)
#define AFX_DRAWUCSDLG_H__29FE68C5_B903_4C19_B7EE_FFD7EBABFDF3__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// DrawUcsDlg.h : header file
//
#include "f_ent.h"
#include "resource.h"
/////////////////////////////////////////////////////////////////////////////
...
class CDrawUcsDlg : public CDialog
{
// Construction
public:
	CDrawUcsDlg(CWnd* pParent = NULL);   // standard constructor
	UCS_STRU ucs;
// Dialog Data
	//{{AFX_DATA(CDrawUcsDlg)
	enum { IDD = IDD_DRAW_UCS_DLG };
	double	m_fAxisX_X;
	double	m_fAxisX_Y;
	double	m_fAxisX_Z;
	double	m_fAxisY_X;
...
#endif // !defined(AFX_DRAWUCSDLG_H__29FE68C5_B903_4C19_B7EE_FFD7EBABFDF3__INCLUDED_)
